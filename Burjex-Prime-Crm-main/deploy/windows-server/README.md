> **Primary production deploy target: `5.226.139.8` (Windows).**
> Do **not** deploy to `187.127.215.195` unless the user explicitly asks.
> See `DEPLOY_TARGET.env`. Old VPS is retired for ongoing work only — leave it running; do not shut it down from here.
