...
InputDecoration authField(String label, {Widget? suffix}) {
...
class AuthPage extends StatelessWidget {
  const AuthPage({super.key, required this.children, this.title, this.onBack});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: onBack == null
            ? null
            : IconButton(icon: const Icon(Icons.arrow_back_ios_new, size: 18), onPressed: onBack),
      ...
      body: SafeArea(
        child: Center(
          child: ConstrainedBox(
            ...
            child: ListView(padding: const EdgeInsets.fromLTRB(24, 8, 24, 32), children: children),
          ),
        ),
      ),
    );
